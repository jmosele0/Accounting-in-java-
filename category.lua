...
local function back ()	
	composer.gotoScene("Tracker2",{effect = "slideRight", time = 500})
end
...
function scene:create( event )
	...
	--title of the scene
	head = display.newText("Category Information", display.contentCenterX*1.0,display.contentCenterY*0.01,"Forte-dv0E",20)
